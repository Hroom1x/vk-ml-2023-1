...
Ваш вариант:
Добавьте к существующим операциям nl - операцию, которая добавляет к каждой переданной на вход строке ее номер, полученная строка передается дальше или выводится на экран
